...
#define ONENET_SEND_BUFFER_LENGTH  (512)
...
Enum_ONENET_Observe_Result	result;// The result of response.
}ST_ONENET_Write_Rsp_Param_t;
...
/******************************************************************************
* Function:     RIL_QONENET_Execute_Rsp
*  
* Description:
