 ...
 *   PWM  APIs defines.
 *
 *	 In the light sleep state, the PWM function will be abnormal.
 *	 When using the PWM function, please use Ql_SleepDisable() to prevent the module entering light sleep.
 *
 * Author:
 * -------
 * -------
